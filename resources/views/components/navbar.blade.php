        ...
        <div class="flex gap-1.5 sm:gap-2 lg:gap-3 items-center">
            ...
            <div class="relative cursor-pointer group">
                ...
                <div class="absolute top-12 sm:top-14 right-0 bg-white rounded-lg shadow-xl z-50 overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 min-w-44 sm:min-w-48 border border-slate-200">
                    <a href="Profile.html" class="block px-4 sm:px-5 py-2.5 sm:py-3 text-slate-700 no-underline text-xs sm:text-sm font-medium transition-all duration-300 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent hover:border-l-blue-600">👤 View Profile</a>
                    <a href="#settings" class="block px-4 sm:px-5 py-2.5 sm:py-3 text-slate-700 no-underline text-xs sm:text-sm font-medium transition-all duration-300 hover:bg-blue-50 hover:text-blue-600 border-l-4 border-transparent hover:border-l-blue-600">⚙️ Settings</a>
